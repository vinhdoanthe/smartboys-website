...
ActiveRecord::Schema[7.0].define(version: 2023_04_17_151148) do
  ...
  create_table "home_page_settings", force: :cascade do |t|
    t.string "hero_title"
  ...
  create_table "matches", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "num_of_team_goals"
    t.integer "num_of_opponent_goals"
